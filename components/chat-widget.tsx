...
export function ChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "Hi! I'm the DreamTeamApps support assistant 👋 I can help with FishingPalPro, Search Quest, PlayListAI, SkinGuardAI, GigStand, and Does It Slap. What can I help you with today?",
    },
  ])
