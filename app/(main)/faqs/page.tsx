...
import { Search, Fish, Music, ChevronDown, ChevronUp, Copy, Check, ExternalLink } from 'lucide-react'
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">
            {ALL_FAQS.length} articles across 3 apps — use this as a quick reference when resolving tickets
          </p>
        </div>
        <a
          href="/portal/faq"
